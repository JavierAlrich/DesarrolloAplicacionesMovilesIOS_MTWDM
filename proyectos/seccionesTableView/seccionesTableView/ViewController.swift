...
//  seccionesTableView
//
//  Created by Javier Omedes on 07/05/21.
//
...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        automoviles = ["Honda","Lamborghini", "Audi","BMW","Bugatti", "Bentley","Chevrolet", "Cadillac", "Aston Martin", "Dodge","Ferrari", "Ford","Jaguar","Mercedes", "Mazda","Nissan","Porsche","Rolls Royce","Toyota","Volkswagen"]
